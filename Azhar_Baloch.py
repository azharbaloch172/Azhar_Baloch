...
logo = """
| "-" "-" "-" "-" "-" "-" "-" "-" "-" "-" "-" "-" "-" "-" "-" "-" "-" "-""-""-""-""-""-""-""-""-""-""-"
|x1b[1;91m➜Owner        ヾ(˙❥˙)ﾉ    AZHAR BALOCH＼(°o°)／
|x1b[1;92m➜Facebook   ヾ(˙❥˙)ﾉ   Azhar＼(◎o◎)／
|x1b[1;93m➜Youtube      ヾ(˙❥˙)ﾉ   Technical Azhar＼(°o°)／
|x1b[1;94m➜Whattsapp ヾ(˙❥˙)ﾉ    Baloch__Worlds＼(◎o◎)／
|x1b[1;95m➜Github         ヾ(˙❥˙)ﾉ   azharbaloch172＼(°o°)／ 
|x1b[1;97m➜Note          ヾ(˙❥˙)ﾉ      Dil Sa Ap Ka Welcome＼(◎o◎)／
...
def login():
	...
	print "\033[1;31m[5]Join Facebook Page  For Help"
...
def menu():
	...
	try:
		...
		keluar()
	os.system("clear") #Dev:Azhar_Baloch
	print logo
	...
	time.sleep(0.05)
	print "\033[1;97m•-----------------\033[1;37mAzhar.Baloch\033[1;97m-----------------•"
